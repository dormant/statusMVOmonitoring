...
plot "../data/pingFlood/mvocobweb1-172.20.0.64-opsproc3.txt" using 1:2 with points pt 5 title "mvocobweb1"
...
plot "../data/pingFlood/earthworm02-172.17.102.61-opsproc3.txt" using 1:2 with points pt 5 title "earthworm2"
