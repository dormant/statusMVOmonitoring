...
plotTimeLimits = [ datetime(datesBeg,'ConvertFrom','datenum') datetime(datesEnd,'ConvertFrom','datenum') ];
...
save( '/mnt/mvofls2/Seismic_Data/monitoring_data/status/wws_da/daily_nsta.mat', 'datNumSta', 'numSta' );
...
plotOverTitle( 'Daily Seismic Data Availability (%)' );
%plotDir = '/mnt/mvofls2/Seismic_Data/monitoring_data/status/wws_da';
plotFileName = 'DailyDataAvail.png';
